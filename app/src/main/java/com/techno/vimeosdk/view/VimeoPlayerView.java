package com.techno.vimeosdk.view;
...
import com.techno.vimeosdk.R;
import com.techno.vimeosdk.listeners.VimeoPlayerErrorListener;
...
import com.techno.vimeosdk.listeners.VimeoPlayerTextTrackListener;
import com.techno.vimeosdk.listeners.VimeoPlayerTimeListener;
import com.techno.vimeosdk.listeners.VimeoPlayerVolumeListener;
import com.techno.vimeosdk.model.PlayerState;
import com.techno.vimeosdk.model.TextTrack;
import com.techno.vimeosdk.model.VimeoOptions;
import com.techno.vimeosdk.utils.JsBridge;
import com.techno.vimeosdk.utils.Utils;
import com.techno.vimeosdk.view.menu.ViemoMenuItem;
...
public class VimeoPlayerView extends FrameLayout implements LifecycleObserver {
    ...
    public VimeoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutParams vimeoPlayerLp = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
